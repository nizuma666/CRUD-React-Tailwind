...
import { registerRecruiter, registerWorker } from "../../config/reducer/authSlice.js";
      ...
      <div className="w-full flex p-5 justify-around h-screen mx-auto max-[768px]:flex-col max-[768px]:gap-y-4">
        ...
        <div className="flex flex-col justify-center w-1/2 h-full pl-10 max-lg:pl-0 max-lg:w-full">
          ...
          onClick={()=>handleActiveForm("recruiter")}
              className={`w-1/4 h-10 border-none text-lg text-white bg-orange-gelap cursor-pointer rounded-lg text-center ${isActiveForm === "recruiter" ? "bg-orange-300" : ""}`}
            >
              Rekruter
            </button>
            <button
            onClick={()=>handleActiveForm("worker")}
              className={`w-1/4 h-10 border-none text-lg text-white bg-orange-gelap cursor-pointer rounded-lg text-center ${isActiveForm === "worker" ? "bg-orange-300" : ""}`}
            >
              Pekerja
            </button>
            </div>
            {isActiveForm === "recruiter" && (<div className="mb-5">
            <div className="mb-5">
              ...
              <input
                ...
                name="email"
                className="bg-white p-0 w-full h-10 rounded-lg text-sm border-none outline-none indent-4"
                type="email"
          ...
          {isActiveForm === "worker" && (<div className="mb-5">
            <div className="mb-5">
              <label className="text-sm text-abu-gelap">Email</label>
              <input
